...
const Profile: React.FC = () => {
  ...
  const [hobbies, setHobbies] = useState("Web Development, Music");
  const [studentId, setStudentId] = useState("123456789");
  const [isDarkMode, setIsDarkMode] = useState(true);
  const [isDropdownOpen, setIsDropdownOpen] = useState(false);
  const [theme, setTheme] = useState("dark");

  // State for musical details
  ...
  return (
    <div
      className={clsx("min-h-screen mx-auto sm:px-6 sm:py-4", {
        dark: isDarkMode,
      })}
    >
      <div
      ...
      >
        ...
        <div className="mt-6">
          ...
          >
            <FaPhone className="mr-2" /> Phone: {phone}
          </p>
          <p
            className={clsx("flex items-center", {
              "text-black": !isDarkMode,
          ...
          >
            <FaCity className="mr-2" /> City: {city}
          </p>
          <p
            className={clsx("flex items-center", {
              "text-black": !isDarkMode,
          ...
          >
            <FaMusic className="mr-2" /> Hobbies: {hobbies}
          </p>
          <p
            className={clsx("flex items-center", {
              "text-black": !isDarkMode,
          ...
          >
            <FaUser className="mr-2" /> Student ID: {studentId}
          </p>
        </div>
        <div
          className={clsx("mt-6", {
              ...
              <div className="mt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <input
                    ...
                    onChange={(e) => setInstrumentsPlayed(e.target.value)}
                    className="p-2 border rounded bg-gray-200 dark:bg-gray-700 text-black dark:text-white"
                  />
                  <input
                    type="text"
                  ...
                  <input
                    ...
                    value={goalsAspirations}
                    onChange={(e) => setGoalsAspirations(e.target.value)}
                    className="p-2 border rounded bg-gray-200 dark:bg-gray-700 text-black dark:text-white"
                  />
                  <input
                    type="text"
                    placeholder="Events and Workshops"
                    value={eventsWorkshops}
                    onChange={(e) => setEventsWorkshops(e.target.value)}
                    className="p-2 border rounded bg-gray-200 dark:bg-gray-700 text-black dark:text-white"
                  />
                  <input
                    type="text"
                  ...
                  <input
                    type="text"
                    placeholder="Teacher Feedback or Reviews"
